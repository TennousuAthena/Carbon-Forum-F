				...
				<tbody>
					...
					<tr>
						...
						<td width="auto" align="left">
							<label><input type="text" name="VerifyCode" autocomplete="off" class="w100" onfocus="document.getElementById('Forgot_Verification_Code_Img').src='<?php echo $Config['WebsitePath']; ?>/seccode.php';document.getElementById('Forgot_Verification_Code_Img').style.display='inline';" value="" placeholder="<?php echo $Lang['Verification_Code']; ?>" /></label>
