...
UE.I18N["ru"] = {
	...
	"autoupload": {
		"exceedSizeError": "Размер файла превышает",
	...
	"elementPathTip": "Путь",
	"wordCountTip": "Количество слов",
	"wordCountMsg": "{#count} введенных символов, осталось {#leave}. ",
	"wordOverFlowMsg": "<span style=\"color:red;\">Количество символов превышает допустимые максимальные значения, сервер может отказать в сохранении!</span>",
	"ok": "OK",
	"cancel": "Отмена",
	...
	"contextMenu": {
		"delete": "Удалить",
		"selectall": "Выбрать все",
		"deletecode": "Удалить сод",
		"cleardoc": "Очистить документ",
		"confirmclear": "Вы уверены, чтобы хотите очистить документ?",
		"unlink": "Unlink",
		"paragraph": "Параграф",
